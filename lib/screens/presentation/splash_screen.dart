              ...
              child: Transform.scale(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Logo: rotate conditionally during the Hero flight
                      Hero(
                        tag: 'penny_logo',
                        ...
                        flightShuttleBuilder: (flightContext, animation, flightDirection, fromHeroContext, toHeroContext) {
                          ...
                          return AnimatedBuilder(
                            animation: animation,
                            builder: (context, _) {
                              if (!_rotateDuringFlight) {
                                // 🚫 No rotation (used for sign-in)
                                return RepaintBoundary(child: shuttleChild);
                              }
                              // ✅ Rotate for other routes
                              final sign = (flightDirection == HeroFlightDirection.push) ? 1.0 : -1.0;
                              final angle = animation.value * sign * (math.pi / 1);
