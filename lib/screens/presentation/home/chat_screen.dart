...
class _ChatScreenState extends State<ChatScreen> {
  ...
  //   setState(() {
  //     // Add user message using Map<String, Object>
  //     messages.add({
  //       'role': 'user' as Object,
  //       'msg': userMessage as Object,
  ...
  //     if (!kIsWeb) {
  //       try {
  //         if (documentContext.hasDocument && documentContext.lastFilePath.isNotEmpty) {
  ...
  //         }
  //       } catch (e) {
  //         print('File access error (iOS): $e');
  //       }
  //     } else {
  //       // Web platform
  //       if (documentContext.hasDocument && documentContext.lastFilePath.isNotEmpty) {
  //         fileToSend = File(documentContext.lastFilePath);
  //       }
  //     }
  //
  ...
  //
  //         // Update the last bot message with the ID from the service
  //         setState(() {
  //           final lastIndex = messages.length - 1;
  //           if (lastIndex >= 0 && messages[lastIndex]['role'] == 'bot') {
  //             messages[lastIndex] = {
  //               ...messages[lastIndex],
  //               'id': message.id as Object,
  //               'msg': message.text as Object,
  //               'isComplete': message.isComplete as Object,
  //             };
  //
  ...
  //             _isTyping = false;
  //
  //             // Mark the last message as complete even if there was an error
  //             final lastIndex = messages.length - 1;
  //             if (lastIndex >= 0 && messages[lastIndex]['role'] == 'bot') {
  //               messages[lastIndex] = {
  //                 ...messages[lastIndex],
  //                 'isComplete': true as Object,
  //                 // Add error message if the response is empty
  //                 'msg': (messages[lastIndex]['msg'] as String).isEmpty
  //                     ? 'Error: Could not generate response.' as Object
  //                     : messages[lastIndex]['msg'] as Object,
  //               };
  //             }
  //           });
  //
  ...
  //             ...messages[lastIndex],
  //             'isComplete': true as Object,
  //             'msg': 'Error: ${e.toString()}' as Object,
  //           };
  //         }
  //       });
  //
