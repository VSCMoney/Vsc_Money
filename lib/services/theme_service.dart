...
class ThemeService {
  ...
  Future<void> loadThemeFromPrefs() async {
    ...
    SystemChrome.setSystemUIOverlayStyle(currentOverlay);
  }
  ...
  SystemUiOverlayStyle get currentOverlay => isDark
...
class AppThemeExtension extends ThemeExtension<AppThemeExtension> {
  ...
  const AppThemeExtension(this.theme);

  @override
  AppThemeExtension copyWith({AppTheme? theme}) =>
      AppThemeExtension(theme ?? this.theme);
